...
gravity :vid_center4,    [ 15,  10, 70, 60]

gravity :video_small,    [ 68,  0, 32, 33]
gravity :video_small2,   [ 80,  0, 20, 21]

gravity :video_wd1,      [ 68,  0, 32, 25]
gravity :video_wd2,      [ 80,  0, 20, 16]
gravity :video_wd3,      [ 50,  0, 50, 39]

gravity :video_sq,       [ 70,  0, 30, 40]

gravity :video_sq1,      [ 85,  0, 15, 21]
gravity :video_sq2,      [ 76,  0, 24, 33]
gravity :video_sq3,      [ 63,  0, 37, 50]
...
grab "C-S-W-Up",    [ :video_wd1,    :video_wd2,     :video_wd3      ]
grab "C-S-W-Down",  [ :video_wd3,    :video_wd2,     :video_wd1      ]
...
tag "pdf" do 
  match "evince|mirage|zathura|comix|texstudio|ktikz|pdfpc"
end
