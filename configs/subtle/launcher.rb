  ...
  module Contrib # {{{
    ...
    class Launcher # {{{
      ...
      def move
        ...
        @width  = geo.width * 30 / 100
        @x      = geo.width * 50 / 100 - (@width / 2)
        @y      = geo.height * 4 / 100 + @font_height1 - @font_height2 
        #@x      = geo.x + ((geo.width - @width) / 2)
        #@y     = geo.y + geo.height - @font_height1 - @font_height2 
